...
type LinkCountryViewCounterRepository interface {
	Find(ctx context.Context, idLink shared_domain_context.Id, countryCode shared_domain.CountryCode) (pkg.Optional[*LinkCountryViewCounter], error)
	...
	RemoveByLink(ctx context.Context, idLink shared_domain_context.Id) error
}
...
func (m *LinkCountryViewCounterRepositoryMock) Find(ctx context.Context, idLink shared_domain_context.Id, countryCode shared_domain.CountryCode) (pkg.Optional[*LinkCountryViewCounter], error) {
...
func (m *LinkCountryViewCounterRepositoryMock) RemoveByLink(ctx context.Context, idLink shared_domain_context.Id) error {
